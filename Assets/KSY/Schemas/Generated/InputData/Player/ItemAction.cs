...
public struct ItemAction : IFlatbufferObject
{
  ...
  public byte ChargeGauge { get { int o = __p.__offset(12); return o != 0 ? __p.bb.Get(o + __p.bb_pos) : (byte)0; } }
  ...
  public static Offset<InputData.Player.ItemAction> CreateItemAction(FlatBufferBuilder builder,
    ...
    ItemAction.AddChargeGauge(builder, charge_gauge);
  ...
  public static void AddChargeGauge(FlatBufferBuilder builder, byte chargeGauge) { builder.AddByte(4, chargeGauge, 0); }
...
static public class ItemActionVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 12 /*ChargeGauge*/, 1 /*byte*/, 1, false)
